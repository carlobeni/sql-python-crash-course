...
* **[install/](file:///d:/TestSQLPython/install/README.md)**: Guía de configuración de herramientas por terminal (`sqlcmd`, `sqlite3`) y ejecutor auxiliar `run_sql.py`.
...
* **[dia-02-sql-avanzado/](file:///d:/TestSQLPython/dia-02-sql-avanzado/README.md)**: Uniones (`INNER`, `LEFT`, `RIGHT`, `FULL`), Trampa de filtros en Joins, Subqueries, Vistas y Tuning.
...
* **[dia-05-python-pandas-numpy/](file:///d:/TestSQLPython/dia-05-python-pandas-numpy/README.md)**: Arrays NumPy, Series/DataFrames, Selección `.loc` vs `.iloc`, Filtros booleanos condicionales y Agregaciones `groupby()` / `merge()`.
...
### 1. Probar scripts de SQL desde PowerShell
Para ejecutar cualquier archivo `.sql` desde la terminal sin necesidad de configurar servidores de base de datos:
...
Para más opciones de instalación con SQL Server (`sqlcmd`) o `sqlite3`, consulta la **[Guía de Instalación](file:///d:/TestSQLPython/install/README.md)**.

### 2. Ejecutar ejercicios de Python
